...
#SBATCH --job-name=llava_text_only_vqa
#SBATCH --mem=24G
#SBATCH -t 0-12:00
#SBATCH -p gpu_requeue
#SBATCH -o /n/netscratch/kdbrantley_lab/Lab/jiajunh/vlm_val/logs/llava_text_only_vqa_%j.out
#SBATCH -e /n/netscratch/kdbrantley_lab/Lab/jiajunh/vlm_val/logs/llava_text_only_vqa_%j.err
