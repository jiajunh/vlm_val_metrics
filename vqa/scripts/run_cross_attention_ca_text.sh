...
#SBATCH --job-name=llava_cross_attention_ca_text
#SBATCH --mem=24G
#SBATCH -t 0-16:00
#SBATCH -p gpu_requeue
#SBATCH -o /n/netscratch/kdbrantley_lab/Lab/jiajunh/test_verl/logs/llava_cross_attention_ca_text_%j.out
#SBATCH -e /n/netscratch/kdbrantley_lab/Lab/jiajunh/test_verl/logs/llava_cross_attention_ca_text_%j.err
